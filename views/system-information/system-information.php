 ...
 *
 * @author Tech Banker
 * @package clean-up-booster/views/system-information
 * @version 2.0
 */
...
if ( ! is_user_logged_in() ) {
	...
	if ( ! $access_granted ) {
		return;
	} elseif ( SYSTEM_INFORMATION_CLEAN_UP_BOOSTER === '1' ) {
		?>
		<div class="page-bar">
									...
									<table class="table table-striped table-bordered table-hover" >
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<span>
														<?php echo esc_html( isset( $_SERVER['SERVER_SOFTWARE'] ) ? wp_unslash( $_SERVER['SERVER_SOFTWARE'] ) : '' ); // WPCS: sanitization ok. ?>
													</span>
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td>
													<span>
														<?php echo esc_attr( PHP_OS ); ?>&nbsp;(<?php echo intval( PHP_INT_SIZE * 8 ); ?>&nbsp;Bit)
													</span>
												</td>
											</tr>
											<tr>
