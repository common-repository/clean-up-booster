							...
							<div class="form-body">
								<div class="form-actions">
									<div class="table-top-margin">
										...
										<a href="admin.php?page=cub_add_new_schedule_clean_up_db" class="btn vivid-green" name="ux_btn_apply" id="ux_btn_apply" ><?php echo esc_attr( $cub_add_new_scheduled_clean_up_label ); ?></a>
									</div>
