 ...
 *
 * @author Tech Banker
 * @package clean-up-booster/views/roles-and-capabilities
 * @version 2.0
 */
...
if ( ! is_user_logged_in() ) {
	...
	if ( ! $access_granted ) {
		return;
	} elseif ( ROLES_AND_CAPABILITIES_CLEAN_UP_BOOSTER === '1' ) {
						...
						<form id="ux_frm_roles_and_capabilities">
							<div class="form-body">
								<div class="form-group">
									<label class="control-label">
										<?php echo esc_attr( $cub_roles_and_capabilities_clean_up_booster_menu_label ); ?> :
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_choose_specific_role ); ?>" data-placement="right"></i>
										...
										<thead>
											<tr>
												<th>
													...
													<?php echo esc_attr( $cub_roles_and_capabilities_administrator_label ); ?>
												</th>
												<th>
													<input type="checkbox"  name="ux_chk_author" id="ux_chk_author"  value="1" onclick="show_roles_capabilities_clean_up_booster(this, 'ux_div_author_roles');" <?php echo '1' === $roles_and_capabilities[1] ? 'checked = checked' : ''; ?>>
													<?php echo esc_attr( $cub_roles_and_capabilities_author_label ); ?>
												</th>
												<th>
													<input type="checkbox"  name="ux_chk_editor" id="ux_chk_editor" value="1" onclick="show_roles_capabilities_clean_up_booster(this, 'ux_div_editor_roles');" <?php echo '1' === $roles_and_capabilities[2] ? 'checked = checked' : ''; ?>>
													<?php echo esc_attr( $cub_roles_and_capabilities_editor_label ); ?>
												</th>
												<th>
													<input type="checkbox"  name="ux_chk_contributor" id="ux_chk_contributor"  value="1" onclick="show_roles_capabilities_clean_up_booster(this, 'ux_div_contributor_roles');" <?php echo '1' === $roles_and_capabilities[3] ? 'checked = checked' : ''; ?>>
													<?php echo esc_attr( $cub_roles_and_capabilities_contributor_label ); ?>
												</th>
												<th>
													<input type="checkbox"  name="ux_chk_subscriber" id="ux_chk_subscriber" value="1" onclick="show_roles_capabilities_clean_up_booster(this, 'ux_div_subscriber_roles');" <?php echo '1' === $roles_and_capabilities[4] ? 'checked = checked' : ''; ?>>
													<?php echo esc_attr( $cub_roles_and_capabilities_subscriber_label ); ?>
												</th>
												<th>
													<input type="checkbox"  name="ux_chk_other" id="ux_chk_other" value="1" onclick="show_roles_capabilities_clean_up_booster(this, 'ux_div_other_roles');" <?php echo '1' === $roles_and_capabilities[5] ? 'checked = checked' : ''; ?>>
													<?php echo esc_attr( $cub_roles_and_capabilities_other_label ); ?>
												</th>
											</tr>
										</thead>
									</table>
								...
								<div class="form-group">
									<label class="control-label">
										<?php echo esc_attr( $cub_roles_and_capabilities_clean_up_top_bar_menu_label ); ?> :
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_clean_up_top_bar_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
									</label>
									<select name="ux_ddl_clean_up_booster_menu" id="ux_ddl_clean_up_booster_menu" class="form-control">
								...
								<div class="form-group">
									<div id="ux_div_administrator_roles">
										<label class="control-label">
											<?php echo esc_attr( $cub_roles_and_capabilities_administrator_role_label ); ?> :
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_choose_page_admin_access_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
										</label>
												...
												<thead>
													<tr>
														<th style="width: 40% !important;">
															...
															<?php echo esc_attr( $cub_roles_and_capabilities_full_control_label ); ?>
													</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													<td>
														...
														<?php echo esc_attr( $cub_database_scheduled_clean_up ); ?>
													</td>
													<td>
							...
							<div class="form-group">
								<div id="ux_div_author_roles">
									<label class="control-label">
										<?php echo esc_attr( $cub_roles_and_capabilities_author_role_label ); ?> :
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_choose_page_author_access_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
									</label>
									<div class="table-margin-top">
										<table class="table table-striped table-bordered table-hover" id="ux_tbl_author">
											<thead>
												<tr>
													<th style="width: 40% !important;">
														<input type="checkbox" name="ux_chk_full_control_author" id="ux_chk_full_control_author" value="1"  onclick="full_control_function_clean_up_booster(this, 'ux_div_author_roles');"  <?php echo isset( $author ) && '1' === $author[0] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_roles_and_capabilities_full_control_label ); ?>
													</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_advance_security_author" id="ux_chk_advance_security_author" value="1" <?php echo isset( $author ) && '1' === $author[7] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_advance_security_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_templates_author" id="ux_chk_templates_author" value="1" <?php echo isset( $author ) && '1' === $author[8] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_email_templates_label ); ?>
													</td>
													<td>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_cron_jobs_author" id="ux_chk_cron_jobs_author" value="1" <?php echo isset( $author ) && '1' === $author[10] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_cron_jobs_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_system_information_author" id="ux_chk_system_information_author" value="1" <?php echo isset( $author ) && '1' === $author[11] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_system_information_label ); ?>
													</td>
													<td>
													</td>
							...
							<div class="form-group">
								<div id="ux_div_editor_roles">
									<label class="control-label">
										<?php echo esc_attr( $cub_roles_and_capabilities_editor_role_label ); ?> :
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_choose_page_editor_access_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
									</label>
									<div class="table-margin-top">
										<table class="table table-striped table-bordered table-hover" id="ux_tbl_editor">
											<thead>
												<tr>
													<th style="width: 40% !important;">
														<input type="checkbox" name="ux_chk_full_control_editor" id="ux_chk_full_control_editor" value="1" onclick="full_control_function_clean_up_booster(this, 'ux_div_editor_roles');" <?php echo isset( $editor ) && '1' === $editor[0] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_roles_and_capabilities_full_control_label ); ?>
													</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_advance_security_editor" id="ux_chk_advance_security_editor" value="1" <?php echo isset( $editor ) && '1' === $editor[7] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_advance_security_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_templates_editor" id="ux_chk_templates_editor" value="1" <?php echo isset( $editor ) && '1' === $editor[8] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_email_templates_label ); ?>
													</td>
													<td>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_cron_jobs_editor" id="ux_chk_cron_jobs_editor" value="1" <?php echo isset( $editor ) && '1' === $editor[10] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_cron_jobs_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_system_information_editor" id="ux_chk_system_information_editor" value="1" <?php echo isset( $editor ) && '1' === $editor[11] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_system_information_label ); ?>
													</td>
													<td>
													</td>
							...
							<div class="form-group">
								<div id="ux_div_contributor_roles">
									<label class="control-label">
										<?php echo esc_attr( $cub_roles_and_capabilities_contributor_role_label ); ?> :
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_choose_page_contributor_access_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
									</label>
									<div class="table-margin-top">
										<table class="table table-striped table-bordered table-hover" id="ux_tbl_contributor">
											<thead>
												<tr>
													<th style="width: 40% !important;">
														<input type="checkbox" name="ux_chk_full_control_contributor" id="ux_chk_full_control_contributor" value="1" onclick="full_control_function_clean_up_booster(this, 'ux_div_contributor_roles');" <?php echo isset( $contributor ) && '1' === $contributor[0] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_roles_and_capabilities_full_control_label ); ?>
													</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_advance_security_contributor" id="ux_chk_advance_security_contributor" value="1" <?php echo isset( $contributor ) && '1' === $contributor[7] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_advance_security_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_templates_contributor" id="ux_chk_templates_contributor" value="1" <?php echo isset( $contributor ) && '1' === $contributor[8] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_email_templates_label ); ?>
													</td>
													<td>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_cron_jobs_contributor" id="ux_chk_cron_jobs_contributor" value="1" <?php echo isset( $contributor ) && '1' === $contributor[10] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_cron_jobs_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_system_information_contributor" id="ux_chk_system_information_contributor" value="1" <?php echo isset( $contributor ) && '1' === $contributor[11] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_system_information_label ); ?>
													</td>
													<td>
													</td>
							...
							<div class="form-group">
								<div id="ux_div_subscriber_roles">
									<label class="control-label">
										<?php echo esc_attr( $cub_roles_and_capabilities_subscriber_role_label ); ?> :
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_choose_page_subscriber_access_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
									</label>
									<div class="table-margin-top">
										<table class="table table-striped table-bordered table-hover" id="ux_tbl_subscriber">
											<thead>
												<tr>
													<th style="width: 40% !important;">
														<input type="checkbox" name="ux_chk_full_control_subscriber" id="ux_chk_full_control_subscriber" value="1" onclick="full_control_function_clean_up_booster(this, 'ux_div_subscriber_roles');" <?php echo isset( $subscriber ) && '1' === $subscriber[0] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_roles_and_capabilities_full_control_label ); ?>
													</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_advance_security_subscriber" id="ux_chk_advance_security_subscriber" value="1" <?php echo isset( $subscriber ) && '1' === $subscriber[7] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_advance_security_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_templates_subscriber" id="ux_chk_templates_subscriber" value="1" <?php echo isset( $subscriber ) && '1' === $subscriber[8] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_email_templates_label ); ?>
													</td>
													<td>
												...
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_cron_jobs_subscriber" id="ux_chk_cron_jobs_subscriber" value="1" <?php echo isset( $subscriber ) && '1' === $subscriber[10] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_cron_jobs_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_system_information_subscriber" id="ux_chk_system_information_subscriber" value="1" <?php echo isset( $subscriber ) && '1' === $subscriber[11] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_system_information_label ); ?>
													</td>
													<td>
													</td>
							...
							<div class="form-group">
								<div id="ux_div_other_roles">
									<label class="control-label">
										<?php echo esc_attr( $cub_roles_and_capabilities_other_role_label ); ?> :
										<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_choose_page_other_access_tooltip ); ?>" data-placement="right"></i>
										<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
									</label>
									<div class="table-margin-top">
										<table class="table table-striped table-bordered table-hover" id="ux_tbl_other">
											<thead>
												<tr>
													<th style="width: 40% !important;">
														<input type="checkbox" name="ux_chk_full_control_other" id="ux_chk_full_control_other" value="1" onclick="full_control_function_clean_up_booster(this, 'ux_div_other_roles');" <?php echo isset( $other ) && '1' === $other[0] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_roles_and_capabilities_full_control_label ); ?>
													</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr>
													...
													<td>
														<input type="checkbox" name="ux_chk_general_settings_other" id="ux_chk_general_settings_other" value="1" <?php echo isset( $other ) && '1' === $other[6] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_general_settings_label ); ?>
													</td>
												</tr>
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_advance_security_other" id="ux_chk_advance_security_other" value="1" <?php echo isset( $other ) && '1' === $other[7] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_advance_security_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_templates_other" id="ux_chk_templates_other" value="1" <?php echo isset( $other ) && '1' === $other[8] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_email_templates_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_roles_other" id="ux_chk_roles_other" value="1" <?php echo isset( $other ) && '1' === $other[9] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_roles_capabilities_label ); ?>
													</td>
												</tr>
												<tr>
													<td>
														<input type="checkbox" name="ux_chk_cron_jobs_other" id="ux_chk_cron_jobs_other" value="1" <?php echo isset( $other ) && '1' === $other[10] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_cron_jobs_label ); ?>
													</td>
													<td>
														<input type="checkbox" name="ux_chk_system_information_other" id="ux_chk_system_information_other" value="1" <?php echo isset( $other ) && '1' === $other[11] ? 'checked = checked' : ''; ?>>
														<?php echo esc_attr( $cub_system_information_label ); ?>
													</td>
													<td>
													</td>
							...
							<div class="form-group">
								<div id="ux_div_other_roles_capabilities">
									<label class="control-label">
											<?php echo esc_attr( $cub_roles_and_capabilities_other_roles_capabilities ); ?> :
											<i class="icon-custom-question tooltips" data-original-title="<?php echo esc_attr( $cub_roles_and_capabilities_other_roles_capabilities_tooltip ); ?>" data-placement="right"></i>
											<span class="required" aria-required="true"> <?php echo '( ' . esc_attr( $cub_premium_editions_label ) . ' )'; ?></span>
										</label>
										<div class="table-margin-top">
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_other_roles">
												<thead>
													<tr>
														<th style="width: 40% !important;">
															<input type="checkbox" name="ux_chk_full_control_other_roles" id="ux_chk_full_control_other_roles" value="1" onclick="full_control_function_clean_up_booster(this, 'ux_div_other_roles_capabilities');" <?php echo '1' === $details_roles_capabilities['others_full_control_capability'] ? 'checked = checked' : ''; ?>>
															<?php echo esc_attr( $cub_roles_and_capabilities_full_control_label ); ?>
														</th>
													</tr>
												</thead>
